...
These are the formal counterpart of Section V-D step 1 of [Sen et al.,
*ProvSQL: A General System for Keeping Track of the Provenance and
Probability of Data*][sen2026provsql]: on a read-once Boolean circuit
...
* [Sen et al.][sen2026provsql] (Section V-D step 1)
-/
