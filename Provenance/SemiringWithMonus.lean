...
* [Sen et al., *ProvSQL*][sen2026provsql] (Definition 5)
...
δ interface is consistent with a given characteristic, not as a
...
(Definition 7 / R5 of [Sen et al.][sen2026provsql]). -/
