...
`op` does not. This is how `NOT` over an aggregate comparison is
interpreted (the operator negator of PostgreSQL), with `NOT` pushed
through Boolean combinations by De Morgan duality. -/
