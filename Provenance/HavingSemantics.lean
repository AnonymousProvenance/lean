...
De Morgan duality, complementing the comparison operator of an atom.
-/
...
negations (`NOT` is pushed through Boolean combinations by De Morgan
duality and complements the comparison operator at the leaves). Under
`negated`,
